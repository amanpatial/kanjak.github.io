// Mock data for KANJAK website

export const heroData = {
  title: "Empowering Today's Girls, Shaping Tomorrow's Society",
  subtitle: "From Ritual to Responsibility",
  description: "In North India, Kanjak is a sacred tradition where young girls are worshipped as a form of Maa Durga, symbolizing purity, strength, and divine potential. While we worship girls for one day during festivals, millions struggle every day with lack of education, nutrition, safety, and opportunity.",
  vision: "If a girl is a form of Goddess, she deserves dignity, education, safety, and opportunity every single day — not just during pooja.",
  images: [
    "https://images.unsplash.com/photo-1601305808762-0f5e2676c24d?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA2MDV8MHwxfHNlYXJjaHw0fHxJbmRpYW4lMjBnaXJsJTIwZWR1Y2F0aW9ufGVufDB8fHx8MTc3MDg3OTczNHww&ixlib=rb-4.1.0&q=85",
    "https://images.unsplash.com/photo-1674278882093-3870ef98e826?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjY2NzF8MHwxfHNlYXJjaHwyfHxnaXJsJTIwZW1wb3dlcm1lbnQlMjBob3BlfGVufDB8fHx8MTc3MDg3OTczOXww&ixlib=rb-4.1.0&q=85",
    "https://images.unsplash.com/photo-1573894998033-c0cef4ed722b?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA2MDV8MHwxfHNlYXJjaHwzfHxJbmRpYW4lMjBnaXJsJTIwZWR1Y2F0aW9ufGVufDB8fHx8MTc3MDg3OTczNHww&ixlib=rb-4.1.0&q=85"
  ]
};

export const kanjakValues = [
  {
    letter: "K",
    title: "Knowledge",
    description: "Education & Awareness",
    icon: "BookOpen"
  },
  {
    letter: "A",
    title: "Access",
    description: "Resources, Mentors, Opportunities",
    icon: "Users"
  },
  {
    letter: "N",
    title: "Nurture",
    description: "Care, Guidance, Emotional Support",
    icon: "Heart"
  },
  {
    letter: "J",
    title: "Justice",
    description: "Fairness, Rights, Safety",
    icon: "Scale"
  },
  {
    letter: "A",
    title: "Aspirations",
    description: "Dreams, Career Goals",
    icon: "Target"
  },
  {
    letter: "K",
    title: "Kindness",
    description: "Community & Compassion",
    icon: "Hand"
  }
];
...
export const challenges = [
  {
    ...
    description: "Many girls face interrupted or insufficient education due to economic constraints and family circumstances.",
    icon: "BookX"
  },
  {
    title: "Nutrition & Health",
    description: "Poor nutrition and limited health awareness affect physical and cognitive development.",
    icon: "Utensils"
  },
  {
    title: "Early Responsibilities",
    description: "Household duties and pressure for early marriage often disrupt educational journeys.",
    icon: "Home"
  },
  {
    title: "Career Guidance Gap",
    description: "Lack of mentors and role models limits awareness of career possibilities and pathways.",
    icon: "Compass"
  },
  {
    title: "Confidence Barriers",
    description: "Low self-confidence and fear of public speaking hinder personal and professional growth.",
    icon: "UserX"
  },
  {
    title: "Digital Divide",
    description: "Limited access to technology and digital learning tools creates educational disadvantages.",
    icon: "Laptop"
  }
];
...
export const blogPosts = [
  {
    id: 1,
    title: "The Power of Education in Breaking Poverty Cycles",
    excerpt: "Exploring how education transforms not just individuals, but entire communities and generations.",
    author: "KANJAK Team",
    date: "December 10, 2024",
    category: "Impact",
    image: "https://images.unsplash.com/photo-1699764681875-dd04ce36b1c3"
  },
  {
    id: 2,
    title: "Mentorship Matters: Stories from Our Volunteers",
    excerpt: "Our mentors share their experiences and the profound impact of guiding young girls toward their dreams.",
    author: "Volunteer Contributors",
    date: "December 5, 2024",
    category: "Stories",
    image: "https://images.pexels.com/photos/35124359/pexels-photo-35124359.jpeg"
  },
  {
    id: 3,
    title: "Digital Literacy: Bridging the Technology Gap",
    excerpt: "How we're empowering girls with digital skills essential for the modern world.",
    author: "KANJAK Team",
    date: "November 28, 2024",
    category: "Programs",
    image: "https://images.unsplash.com/photo-1715182141963-6aa3d0a49c5f"
  }
];

export const culturalImages = [
  "https://images.unsplash.com/photo-1715182141963-6aa3d0a49c5f",
  "https://images.unsplash.com/photo-1699764681875-dd04ce36b1c3",
  "https://images.pexels.com/photos/35124359/pexels-photo-35124359.jpeg"
];
